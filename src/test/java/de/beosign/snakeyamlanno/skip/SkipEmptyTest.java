...
public class SkipEmptyTest {
    ...
    public void skipEmptyFalseTest() {
        ...
        Assert.assertThat(dumped, StringContains.containsString("Homer"));
        Assert.assertThat(dumped, StringContains.containsString("collection: []"));
        Assert.assertThat(dumped, StringContains.containsString("map: null"));
        Assert.assertThat(dumped, StringContains.containsString("emptyString:"));
        Assert.assertThat(dumped, StringContains.containsString("nullString: null"));
    }
    ...
    public void skipEmptyTrueTest() {
        ...
        Assert.assertThat(dumped, IsNot.not(StringContains.containsString("notDumped")));
        Assert.assertThat(dumped, StringContains.containsString("Homer"));
        Assert.assertThat(dumped, IsNot.not(StringContains.containsString("collection:")));
        Assert.assertThat(dumped, IsNot.not(StringContains.containsString("map:")));
        Assert.assertThat(dumped, IsNot.not(StringContains.containsString("emptyString:")));
        Assert.assertThat(dumped, IsNot.not(StringContains.containsString("nullString:")));
    }
